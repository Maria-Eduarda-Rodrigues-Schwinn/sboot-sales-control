...
import com.sales_control.pi.dto.request.LoginRequestDTO;
import com.sales_control.pi.dto.response.LoginResponseDTO;
  ...
  public ResponseEntity<LoginResponseDTO> login(@RequestBody LoginRequestDTO dto) {
    ...
    return ResponseEntity.ok(
        LoginResponseDTO.builder()
            .token(token)
            .role(user.userType())
            .roleLabel(user.userType().getTranslation())
            .build());
  }
}
